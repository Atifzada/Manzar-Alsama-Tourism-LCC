  ...
  return (
    <section className='relative bg-hero bg-cover bg-center bg-no-repeat h-[100vh] w-full z-10 pb-12'>
      <div className='max-container padding-container relative top-28 sm:top-1/3 z-10'>
        <h1 className='bold-32 sm:bold-64 text-white capitalize max-w-[36rem]'>Explore Dubai With Us</h1>
        ...
        <h4 className='text-white my-2 bold-18 sm:bold-22 sm:my-4'>Explore the key points</h4>
